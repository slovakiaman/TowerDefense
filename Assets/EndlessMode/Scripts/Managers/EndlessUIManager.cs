...
public class EndlessUIManager : MonoBehaviour
{
    ...
    [Header("SETUP FIELDS")] protected EndlessWaveManager WaveManager;
    protected EndlessGameManager GameManager;
    ...
    protected void Awake()
    {
        ...
        GameManager = GameManagerObject.GetComponent<EndlessGameManager>();
        WaveManager = GameManagerObject.GetComponent<EndlessWaveManager>();
    }
    ...
    public EndlessShop GetShop()
    {
        return shopLeftPanel.GetComponentInParent<EndlessShop>();
    }
    ...
    public void ShowTowerBaseInfo(EndlessTower tower)
    {
    ...
    public void ShowTowerBaseUpgradeInfo(EndlessTower tower)
    {
        shopRightPanel.SetActive(true);
        EndlessTower upgradeTower = tower.GetUpgradeTower().GetComponent<EndlessTower>();
    ...
    public void ShopSelectedTower(EndlessTower tower)
    {
        ShowTowerBaseInfo(tower);
        if (EndlessPlayerManager.instance.CanBuyTower(tower))
        {
            ShowBuyButton(true);
    ...
    public void ShopUpgradeableTower(EndlessTower tower)
    {
        ShowTowerBaseUpgradeInfo(tower);
        EndlessTower upgradeTowerCompoment = tower.GetUpgradeTower().GetComponent<EndlessTower>();
        if (EndlessPlayerManager.instance.CanBuyTower(upgradeTowerCompoment))
        {
    ...
    public void ShopFinalTower(EndlessTower tower)
    {
        ShowTowerBaseInfo(tower);
        ShowBuyButton(false);
        ShowSellButton(true);
    ...
    public void ShowEventPanel(EndlessLevelEvent endlessEvent)
    {
        ...
        if (endlessEvent.positiveEffect)
        {
        ...
        name.text = endlessEvent.name;
        description.text = endlessEvent.description;
        duration.text = "Duration: " + endlessEvent.duration + " waves";
